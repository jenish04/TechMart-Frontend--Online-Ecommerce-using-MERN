...
function NavBar({ children }) {
  ...
  <a href="https://covrize.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://cdn.iconscout.com/icon/premium/png-512-thumb/t-175-1042949.png?f=webp&w=256" class="h-8" alt="Flowbite Logo" />
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TechMart</span>
  </a>
